      ...
      <nav className='nav'>
        ...
        <div className='nav__content'>
          ...
          <div className={`nav__popup ${toggleNavPopup ? 'nav__popup--open' : ''}`}>
            <h3>Scan</h3>
            <QRCode size={138} value='https://get.fuse.cash/mrxn/81725d2?af_qr=true' />
          </div>
          <a href='https://get.fuse.cash/mrxn/81725d2' rel='noreferrer noopener' target='_blank' className='nav__buttonMobile'>Download app</a>
        </div>
      </nav>
          ...
          <div>
            ...
            <div style={{ position: 'relative', display: 'flex', justifyContent: 'center' }}>
              <div className={`large_popup ${toggleMainPopup ? 'large_popup--open' : ''}`}>
                <QRCode size={298} value='https://get.fuse.cash/mrxn/81725d2?af_qr=true' />
                <h3>Scan Me</h3>
              </div>
              <button onClick={handleMainPopup} className='download'>
                Download app
              </button>
              <a href='https://get.fuse.cash/mrxn/81725d2' rel='noreferrer noopener' target='_blank' className='downloadMobile'>
                Download app
              </a>
            </div>
          ...
          <div className='image'>
            ...
            <div className='footer grid-x  align-justify'>
              ...
              <div className='footer-links'>
                <h3>DApp</h3>
                <a href='https://fuse.fi/' target='_blank'>fuse.fi</a>
                <a>Fuse Staking</a>
              </div>

              <div className='footer-links'>
                <h3>Social Media</h3>
                <a href='https://twitter.com/Get_Fuse_Cash' target='_blank'>Twitter</a>
                <a href='https://github.com/fuseio/fuse.cash' target='_blank'>GitHub</a>
                <a href='https://discord.com/invite/jpPMeSZ' target='_blank'>Discord</a>
                <a href='https://medium.com/fusenet' target='_blank'>Medium</a>
                <a href='https://t.me/fusecash' target='_blank'>Telegram</a>
              </div>

              <div className='footer-links'>
                <a className='footer-links__specialLink' href='http://help.fuse.cash/en/' target='_blank'>Support</a>
              </div>
              <div className='footer-last'>
                ...
                <div className='footer-downloadContainer'>
                  <div className='footer-QR'>
                    ...
                    <QRCode size={100} value='https://get.fuse.cash/mrxn/81725d2?af_qr=true' />
                  </div>
